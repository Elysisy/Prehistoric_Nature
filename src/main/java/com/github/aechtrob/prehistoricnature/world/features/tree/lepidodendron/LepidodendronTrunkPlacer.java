...
public class LepidodendronTrunkPlacer extends PNTrunkPlacer {
    ...
    public List<FoliagePlacer.FoliageAttachment> placeTrunk(LevelSimulatedReader levelSimulatedReader, BiConsumer<BlockPos, BlockState> biConsumer, Random random, int p_161871_, BlockPos pos, TreeConfiguration treeConfiguration) {
        ...
        int height = 0;
        int counter = 0;
        BlockState logState = ModBlocks.LEPIDODENDRON_LOG.get().defaultBlockState();
        BlockState woodState = ModBlocks.LEPIDODENDRON_WOOD.get().defaultBlockState();
