...
public class LepidodendronTreeFeature  extends Feature<TreeConfiguration> {

    private static final ResourceLocation LEPIDODENDRON_TREE = new ResourceLocation(PrehistoricNature.MOD_ID, "lepidodendron_tree");

    public LepidodendronTreeFeature(Codec codec) {
        super(codec);
    }
